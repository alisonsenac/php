...
<body>
    ...
    <div class="painel">
        ...
        <div class="chat">
            <?php
                ...
                if($resultado-> num_rows > 0){
                   //linha armazena 1 resultado por vez escolhido pelo fetch_assc
                   // roda looping enquanto fetch_assoc() ler algum regristro
                    while($linha = $resultado -> fetch_assoc()) {
                        echo '<div class="mensagens" >';
                    echo "<p> <br> {$linha['usuario']} </b> {$linha['mensagem']} </p>";
        ...
        <form method="POST" action="">
            <input type="texte" name="usuario" placeholder="Escolha um nome usuario">
