...
<head>
    ...
    <title>Prrocessando Postagem</title>
...
<body>
    <div class="painel">
        ...
        <div class="conteudo">
            <h2>Postagem efetuada com Sucesso!<h/2>
            <?php
                //$usuario = "Bruno";
                //criação de cookie
                ...
                if($_SERVER["REQUEST_METHOD"] == "POST"){
                    ...
                    //região abaixo é criar uma lista de sessão
                    session_start();//iniciar sessão para usar variaveis de sessão
        ...
        <div class="rodape">
            ...
            <a href="buscar.html" class="botao"> Buscar             </a>
